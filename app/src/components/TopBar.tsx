...
export const TopBar = ({
  ...
  const progots = useBoundStore((x) => x.lingots);
    ...
    <header className="fixed z-20 h-[58px] w-full">
      ...
      >
        ...
        <button
          ...
          aria-label="Toggle progot menu"
        >
          {progots > 0 ? <GemSvg /> : <EmptyGemTopBarSvg />}{" "}
          <span
            className={progots > 0 ? "text-white" : "text-black opacity-20"}
          >
            {progots}
          </span>
        </button>
