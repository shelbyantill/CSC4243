...
export const useBottomBarItems = () => {
  ...
  const bottomBarItems: BottomBarItem[] = [
    ...
    },
    {
      ...
      className="h-[50px] w-[50px]"
    >
      {/* Outer Circle for Badge (Blue) */}
      <circle cx="23" cy="23" r="20" fill="#3A8DFF" />

      {/* Inner Circle to create a layered badge effect (White) */}
      <circle cx="23" cy="23" r="15" fill="#FFFFFF" />

      {/* Star Icon in the Center (Gold) */}
      <path
        d="M23 13L25.09 18.26H30.18L26.64 21.14L27.73 26.26L23 23.14L18.27 26.26L19.36 21.14L15.82 18.26H20.91L23 13Z"
        fill="#FFD700"  // Gold color for the star
      />

      {/* Ribbon Shape at the Bottom (Gray) */}
      <path
        d="M9 33C9 30.7909 10.7909 28 13 28H33C35.2091 28 37 30.7909 37 33V36C37 37.1046 36.1046 38 35 38H11C9.89543 38 9 37.1046 9 36V33Z"
        fill="#BDC3C7"  // Gray color for the ribbon
      />
